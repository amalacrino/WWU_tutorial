---
title: "DADA2 tutorial - Paired-ends (PE) reads"
output:
...
[Download this file](https://downgit.github.io/#/home?url=https://github.com/amalacrino/files_tutorials/tree/main/WWU_tutorial_1/data) and unzip it inside the folder `project/data`.
...
For this tutorial, you can download one from [here](https://raw.githubusercontent.com/amalacrino/files_tutorials/main/WWU_tutorial_1/metadata.txt) and place it inside the `project/` folder. 
