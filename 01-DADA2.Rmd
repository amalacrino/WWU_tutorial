...
```{r, eval=params$process}
indir <- "project/data"
filter_dir <- 'project/fastq_filtered'
outdir <- 'project/ASVs'
tax <- 'project/SILVA'
tax_key <- 'project/SILVA/silva_nr99_v138.1_wSpecies_train_set.fa.gz'
metadata_file <- 'project/metadata.txt'
tree <- 'project/tree.tre'
asv.final.table <- 'project/ASV_table.rds'
